...
class MockArgs:
    def __init__(
        self, projects: str = None, projectids: str = None, force: bool = False
    ):
...
def test_delete_eligible_none():
    ...
    assert (
        lib.delete_eligible({"JunkData": True, "Invalid": "probably"}, MockArgs())
        == None
    )


projects = [
    {"id": "861469d7-b898-4c6a-8547-e805aad56087", "name": "my-cool-project"},
...
def test_filter_projects_by_name_single():
    ...
    assert {
        "id": "861469d7-b898-4c6a-8547-e805aad56087",
        "name": "my-cool-project",
    } in lib.filter_projects(projects, single_project)


def test_filter_projects_by_name_multiple():
    multiple_project = config.ProjectFilter(
        MockArgs("my-cool-project,myAwesomeProject", None)
    )
    ...
    assert {
        "id": "68b8d347-e97f-4043-bf37-d874c32fbce9",
        "name": "myAwesomeProject",
    } in filteredProjects
    assert {
        "id": "1328afd3-92f8-4a24-9da7-c6a430176365",
        "name": "TheOtherProject1",
    } not in filteredProjects
...
def test_filter_projects_by_id_multiple():
    multiple_project = MockArgs(
        None,
        "861469d7-b898-4c6a-8547-e805aad56087,68b8d347-e97f-4043-bf37-d874c32fbce9,1328afd3-92f8-4a24-9da7-c6a430176365",
    )
    ...
    assert {
        "id": "6558f9a3-045a-4358-821d-5a58c86ae0fd",
        "name": "LeftoverProject",
    } not in filteredProjects
